        ...
        import TagSystemUtils from "https://cdn.jsdelivr.net/gh/trep-kalkyl/tab-res@edd01cd167734c64ce2f5988e02257131c4b1312/tagSystemUtils.js";
        ...
        // ======= HJÄLPFUNKTION FÖR ATT HÄMTA ALLA BEFINTLIGA TAGGAR =======
        ...
        function createTagEditor(cell, onRendered, success, cancel, tagField) {
          // Skapa overlay
        ...
        function addTagsToTable(table, entityType = "item") {
          ...
          const setup = () => {
            ...
            tags.tagEditor = function(cell, onRendered, success, cancel, editorParams) {
              return createTagEditor(cell, onRendered, success, cancel, tagField);
            };
            ...
            tagCol.editor = function(cell, onRendered, success, cancel, editorParams) {
              ...
              // Anropa vår förbättrade editor med modifierad success-callback
