console.time('Script load & UI init'); // Start timer
// ======= IMPORTS =======
...
import * as ImportModule from "https://cdn.jsdelivr.net/gh/trep-kalkyl/tab-res@6ce9900a008bb4c18b70c820ce68d222af5e16b8/ImportModule.js";
...
const setupTables = async () => {
  ...
  partTable.on("tableBuilt", () => {
    ...
    importBtn.title = "Importera Parts, Items eller Tasks från JSON";
    importBtn.onclick = () => {
      ImportModule.showImportDialog(
        project,
        { partTable, itemTable },
        updatePartOptions,
        applyPartFilter
    ...
    partFooter.appendChild(importBtn);
  });
...
console.timeEnd('Script load & UI init'); // Stop timer och skriv ut resultat
